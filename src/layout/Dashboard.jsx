...
import { FaBook, FaCalculator, FaEnvelope, FaHome, FaList, FaSearch, FaShoppingCart, FaUsers, FaUtensils } from 'react-icons/fa';
                ...
                <ul className="menu p-4">
                    {
                        isAdmin ? <>
                            ...
                            <>
                                ...
                                <li >
                                    <NavLink to="/dashboard/review"><FaCalculator></FaCalculator>Add a Review</NavLink>
                                </li>
                                <li >
